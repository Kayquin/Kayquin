...
<h1 align="center">Olá 👋, eu sou o Kayque Avelar</h1>

<p align="center">
  <strong>💻 Desenvolvedor Full Stack • 📱 React Native • ⚡ Suporte ERP • 🚀 Integrador de Sistemas</strong>
</p>

<p align="center">
  <a href="https://github.com/Kayquin">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=00BFFF&center=true&vCenter=true&width=700&lines=Desenvolvedor+Full+Stack;React+%2F+React+Native;E-commerces+e+Landing+Pages;Spring+Boot+%2F+Node.js;Integra%C3%A7%C3%B5es+de+APIs+e+Automa%C3%A7%C3%B5es" alt="Typing SVG" />
  </a>
</p>
...
<img align="right" alt="Dev GIF" width="300px" src="https://github.com/Kayquin/Kayquin/blob/main/img/dev.gif?raw=true"/>

Sou desenvolvedor Full Stack focado na construção de aplicações escaláveis, automações de processos e modelagem de arquiteturas eficientes. Uno a flexibilidade do ecossistema JS/TS (React/Node) com a robustez e tipagem do ecossistema Java (Spring Boot) para solucionar problemas de negócios reais.

- 🎓 **Educação:** Estudante de Análise e Desenvolvimento de Sistemas.
- ⚡ **Área de Atuação Pro:** Integração de sistemas, automação de processos via APIs de comunicação (ex: WhatsApp API), e otimização/suporte para sistemas de gestão (ERP).
- 🌱 **Foco de Estudo Atual:** Arquitetura de microserviços e performance de renderização mobile.
...
<p align="left">
  <a href="https://code.visualstudio.com/" target="_blank"><img alt="VS Code" width="40" height="40" src="https://github.com/Kayquin/Kayquin/blob/main/img/vs.png?raw=true"/></a> &nbsp;
  <a href="https://www.jetbrains.com/idea/" target="_blank"><img alt="IntelliJ IDEA" width="40" height="40" src="https://github.com/Kayquin/Kayquin/blob/main/img/intellij.png?raw=true"/></a> &nbsp;
  <a href="https://dbeaver.io/" target="_blank"><img alt="DBeaver" width="40" height="40" src="https://github.com/Kayquin/Kayquin/blob/main/img/dbeaver.png?raw=true"/></a> &nbsp;
  <a href="https://www.java.com/" target="_blank"><img alt="Java" width="40" height="40" src="https://github.com/Kayquin/Kayquin/blob/main/img/java.png?raw=true"/></a>
</p>
...
*   📊 **Dashboards Administrativos:** Ferramentas de análise interna para exibição de KPIS comerciais.
*   💬 **Integração WhatsApp API:** Gatilhos e bots automáticos integrados a fluxos de vendas ou suporte ERP.

---

## 📊 Estatísticas (Métricas de Desenvolvimento)
...
Se você deseja iniciar um projeto de desenvolvimento, integrar novos canais aos seus sistemas ou automatizar tarefas, sinta-se à vontade para me contatar:
